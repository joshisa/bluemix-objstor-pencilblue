...
module.exports = function BMObjStorMediaProviderModule(pb) {
     ...
     * The second is a JSON payload {"userid":"", "token":"", "url":"", "container":""}
     *
     * userid:  Represents the userId field generated by the bound Bluemix Object Storage instance
        ...
        this.pluginService.getSettingsKV('bluemix-objstor-pencilblue', function(err, setts) {
            ...
            var res_handler = function(error, response, res_body) {
              ...
              if (!error && response.statusCode == 201) {
                ...
                pb.cache.setex('bluemix-objstor-info', "72000", JSON.stringify(body), function(err, result) {
                    if (util.isError(err)) {
                      pb.log.debug(err)
                    }
                    pb.log.info("PencilBlue: Bluemix: Persisting object storage X-Auth-Token for 20 hours of re-use..")
                });
                cb(null, body);
              }
              else {
